                            ...
                            <div className="full_width_box">
                                ...
                                <div className="row">
                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery1} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery2} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>                           <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery3} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery4} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-xl-34col-lg-4 col-md-4 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery5} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery6} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>   <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery7} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                </div>
                                <div className="pd_bottom_70"></div>
                                <div className="row">
                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery8} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery9} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>                           <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery10} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery11} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                </div>
                                <div className="pd_bottom_70"></div>
                                <div className="row">
                                    <div className="col-xl-34col-lg-4 col-md-4 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery12} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery13} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>   <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div className="csr_boxes">
                                            <img src={data?.gallery14} className="simp_img img-fluid " alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
